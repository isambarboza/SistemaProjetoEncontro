...
namespace ProjetoEncontro.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ObservacoesId,ObservacoesDescricao,ObservacoesLocal,ObservacoesData,AnimaisId,UsuarioId")] Observacoes observacoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ObservacoesId,ObservacoesDescricao,ObservacoesLocal,ObservacoesData,AnimaisId,UsuarioId")] Observacoes observacoes)
        {
